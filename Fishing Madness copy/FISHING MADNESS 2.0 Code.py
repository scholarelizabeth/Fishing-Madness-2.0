...
# Fish Types
fish_names = [
    "Bubblefish (Common).gif", "AnglerFish (Common).gif", "Purple Dartfish (Common).gif", "Marsh Eel (Common).gif", "Tail Spiked Dartfish (Rare).gif",
    "Midnight Eel (Rare).gif", "Seafoam Magenta Starfish (Rare).gif", "Narwhal ( Very Rare).gif", "Speckled Great Octopus (Very Rare).gif"    
]


fish_files = [
    f"Bubblefish (Common).gif",
    "AnglerFish (Common).gif",
    "Purple Dartfish (Common).gif",
    "Marsh Eel (Common).gif",
    "Tail Spiked Dartfish (Rare).gif",
    "Midnight Eel (Rare).gif",
    "Seafoam Magenta Starfish (Rare).gif",
    "Narwhal ( Very Rare).gif",
    "Speckled Great Octopus (Very Rare).gif",
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            if state == "Title Screen":
                if start_button_rect.collidepoint(event.pos):
                    ...
                    pygame.mixer.music.load("02. Mii Channel (Plaza).mp3") 
                    pygame.mixer.music.play(-1)
